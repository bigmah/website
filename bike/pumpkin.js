...
// include: /var/folders/06/sphc00m13l12tqmf70tpd4wc0000gn/T/tmpv_04ziq6.js
...
// end include: /var/folders/06/sphc00m13l12tqmf70tpd4wc0000gn/T/tmpv_04ziq6.js
// include: bod-pre.js
...
var ASM_CONSTS = {
  1078860: () => { return stringToNewUTF8(bodEnvString()); },  
 1078904: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 1079119: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 1079266: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 ...
 1087542: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 1087625: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 1087694: () => { return window.innerWidth; },  
 1087724: () => { return window.innerHeight; }
};
